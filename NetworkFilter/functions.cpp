				  ...
				  )
{
	...
	ODS(L"ODS After GetInformation!\n")
	if (lanjie == 0)
	{
...
{
	ODSA(__FUNCTION__);
	//ODS1(L"ODS WSPRecv data: %s , size :%d called!\n", lpBuffers->buf , lpBuffers->len,dwBufferCount);
